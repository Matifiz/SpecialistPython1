...
length = float(input("Введите длину параллелепипеда в метрах:"))
width = float(input("Введите ширину параллелепипеда в метрах:"))
height = float(input("Введите высоту параллелепипеда в метрах:"))
total_square = length*width * 4 + width * height * 2
volume = length * width * height
print(f"Площадь поверхности параллелепипеда: {total_square:.2f} м2")
print(f"Объем параллелепипеда: {volume:.2f} м3")
